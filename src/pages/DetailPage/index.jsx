...
const DetailPage = () => {
    ...
    const formatPokemonStats = ([
        ...
        { name: 'Defense', baseStat: statDBP.base_stat },
        { name: 'Special Attack', baseStat: statSATK.base_stat },
        { name: 'Special Depense', baseStat: statSDEP.base_stat },
    ...
    if (isLoading) {
        return (
            <div className={
                ...
                <Loading CN={`w-12 h-12 z-50 animate-spin text-slate-900`} />
            </div>
        )
    }
        ...
        <article className="flex items-center gap-1 flex-col w-full">
            <div className={
                ...
                {pokemon.next && (
                    ...
                    >
                        <GreaterThan CN={`w-5 h-8 p-1`} />
                    </Link>
                )}
                <section className="w-full flex flex-col z-20 items-center justify-end relative h-full">
                    <div className="absolute z-30 flex top-6 items-center w-full justify-between px-2">
                        <div className="flex items-center gap-1">
                            <Link to="/">
                                <ArrowLeft CN={`w-6 h-8 text-zinc-200`} />
                            </Link>
